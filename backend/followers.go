...
func followUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Printf("Database error checking existing follow relationship (follower_id=%d, following_id=%d): %v",
	...
	_, err = db.Exec("INSERT INTO followers (follower_id, following_id) VALUES (?, ?)",
		followerID, followingID)
	if err != nil {
		log.Printf("Database error inserting follow relationship (follower_id=%d, following_id=%d): %v",
			followerID, followingID, err)
